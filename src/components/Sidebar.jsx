...
import { IconDashboard, IconCheckCircle, IconAlertTriangle, IconRepeat, IconDuplicate, IconChevronLeft, IconCreditCard, IconQrCode, IconUsers } from './Icons'
...
const NAV_ITEMS = [
  ...
  { to: '/for-replacement', label: 'For Replacement', icon: IconRepeat },
